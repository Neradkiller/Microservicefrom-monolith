package com.non_real_ecommerce.user_service.application.service;

import com.non_real_ecommerce.user_service.domain.exception.DomainException;
import com.non_real_ecommerce.user_service.domain.exception.InvalidCredentialsException;
import com.non_real_ecommerce.user_service.domain.exception.InvalidUserStatusException;
import com.non_real_ecommerce.user_service.domain.exception.UserAlreadyExistsException;
...
import com.non_real_ecommerce.user_service.domain.model.UserStatus;
import com.non_real_ecommerce.user_service.domain.port.input.AuthService;
import com.non_real_ecommerce.user_service.domain.port.input.AuthenticationResult;
